	...
	<div>
	 ...
	 <table>
	 	<tr>
			 ...
			 <td text-align: center style="color:black;">Summer Sports</td>
			 <td style="width:20%"><hr/></td>
			 <td style="width:26%" ><hr/></td>
			 <td text-align: center style="color:black;"> Hiking </td>
			 <td style="width:22%"><hr/></td>
		 </tr>
	 </table>
	 ...
	 <table id="w">
		<tr >
			<td style="text-align:left" >
				<img class="img-round" src="images/jetblade_new.jpg" alt="Avatar" align="left"  style="width:128px;height:128px" hspace="20" />
			...
			<td style="text-align:left" style=" padding:0; margin:0; " > 
				<img  class="square" src="images/albania-trekking-from-valbona-to-theth.jpg" alt="Avatar" align="left" style="width:110px;height:130px" hspace="20" />
				<p style="color:black;"><strong>Mountain Climbing</strong</hp>
				<div class="content1" style=" padding:0; margin:0; " >
					<div class="read-more" style=" padding:0; margin:0; ">
		...
		<tr style="text-align:left">
			<td>
				<img class="img-round" src="images/kayaking.jpg" alt="Avatar" align="left" style="width:128px;height:128px" hspace="20" />
